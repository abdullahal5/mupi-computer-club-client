...
// const eventData = {
//   title: "Dummy Fair 2025",
//   images: [
//     "https://img.freepik.com/free-photo/silhouette-person-standing-top-hill-beautiful-sunset-sky_181624-24825.jpg",
//     "https://img.freepik.com/free-photo/beautiful-shot-mountains-trees-covered-snow-fog_181624-24822.jpg",
//     "https://img.freepik.com/free-photo/beautiful-landscape-with-mountains_23-2149046051.jpg",
//   ],
//   time: "10:00 am - 12:00 pm",
//   date: "Sunday, 15 Jan - 2024",
//   location: "IIT-IDF, Madhapur",
//   description:
//     "Get ready for PixelCon 3.0 where creativity meets cutting-edge technology in the ultimate design showdown! This year, we're raising the stakes and diving deeper into the dynamic world of graphic design and digital innovation. Whether you're a seasoned creator or a rising star in the design universe, PixelCon 3.0 will challenge your artistic instincts and push the limits of your imagination. With the motto \"Unleash Your Vision\", this year's contest promises even more thrilling opportunities to showcase your skills. Whether you prefer to fly solo or collaborate with fellow design visionaries, you'll find the perfect platform to demonstrate your craft. From stunning visuals to groundbreaking digital art, ",
//   eligibility: {
//     title: "Eligibility: Club Members",
//     criteria: [
//       "1. Prior designing",
//       "2. Basic coding",
//       "3. Leadership",
    ...
    <div className="fixed z-50 inset-0 bg-black/70 flex items-center justify-center p-4 backdrop-blur-sm">
      {isLoading || isFetching ? (
        ...
        <div className="bg-[#17163A] border border-purple-500/30 shadow-lg shadow-purple-500/20 scrollbar-thin overflow-y-auto max-h-[90vh] text-white rounded-3xl max-w-5xl w-full relative transition-all duration-300 ease-in-out transfor">
          ...
          <button
            onClick={onClose}
            className="absolute right-3 top-3 z-10 bg-black/20 p-2 rounded-full hover:bg-black/30 transition-colors duration-300"
          >
              ...
              <div className="bg-white/5 p-6 rounded-xl backdrop-blur-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <span className="text-gray-300">{eventData?.location}</span>
                  </div>
                </div>
              </div>
              <iframe
