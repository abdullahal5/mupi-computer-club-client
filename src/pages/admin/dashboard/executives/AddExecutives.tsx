...
import { useAddExecutiveMutation } from "../../../../redux/features/executives/executivesApi";
import { useGetAllCommitteesQuery } from "../../../../redux/features/committee/committeeApi";

const AddExecutives = ({ onClose }: { onClose: () => void }) => {
  const [roleType, setRoleType] = useState("");
  const [image, setImage] = useState<string>("");
  const [AddExecutives] = useAddExecutiveMutation();
  ...
  return (
    <div className="max-w-4xl mx-auto overflow-hidden">
      <h2 className="text-4xl font-bold text-white mb-6">Add Executives</h2>
            ...
            <div className="flex gap-4 pt-3">
              ...
              <label className="inline-flex items-center">
                <input
                  ...
                  required
                />
                <span className="ml-2 text-sm text-gray-700">Executive</span>
              </label>
              <label className="inline-flex items-center">
                <input
                  type="radio"
